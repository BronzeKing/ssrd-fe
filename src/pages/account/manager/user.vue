<template lang="pug">
    div
        ...
        div
            ...
            el-input(placeholder="请输入要搜索的账号名称或邮箱" icon="el-icon-search" v-model="User.t.search" @change="User.list()")
            el-table.mt10(:data="User.t.Records" stripe highlight-current-row style="width: 100%")
                ...
                el-table-column(label="操作")
                    template(slot-scope="scope")
                        ...
                        el-button(icon='el-icon-delete' @click="userDestroy(scope.row)")
