<template lang="pug">
    div
        ...
        div
            ...
            el-input(placeholder="授权码名称、项目名称" icon="el-icon-search" v-model="AuthorizeCode.t.search" @change="AuthorizeCode.list()")
            el-table.mt10(:data="AuthorizeCode.t.Records" stripe highlight-current-row style="width: 100%")
                ...
                el-table-column(label="操作")
                    template(slot-scope="scope")
                        ...
                        el-button(icon='el-icon-delete' @click="authorizeCodeDestroy(scope.row)")
