<template lang="pug">
    .page-footer
            ...
            .container.flex
                ul.container-left
                    ...
                    li.left-sub
                        ul.left-sub-flex
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 产品&下单
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 快捷下单
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 最新产品
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 热门产品
                    li.left-sub
                        ul.left-sub-flex
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 新手帮助
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 新手指南
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 交易流程
                    li.left-sub
                        ul.left-sub-flex
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 访问者
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 个人/终端
                            li.left-progeny
                                a.left-content(href="javascript: void(0);") 分销商
                .container-right
                    .left-sub
                        .first-item
        ...
        .container-next-part
            p.f14 版权所有 Copyright &copy; 2006 2017 深圳市盛世润达智能科技有限公司 粤ICP备06083171号
                .network-icnon.mt10
