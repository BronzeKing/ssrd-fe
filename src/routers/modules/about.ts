...
const about = (r: any) =>
  require.ensure([], () => r(require("pages/views/about/about")), "about");
// 公司简介
const companyProfile = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/about/components/company-profile")),
    "about"
  );
// 企业文化
const corporateCulture = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/about/components/corporate-culture")),
    "about"
  );
// 荣耀资质
const honor = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/about/components/honor")),
    "about"
  );
// 合作伙伴
...
const recruit = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/about/components/recruit")),
    "about"
  );
// 联系我们
const contactUs = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/about/components/contact-us")),
    "about"
  );
export default [
  {
