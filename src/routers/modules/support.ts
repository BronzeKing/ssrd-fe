...
const faqs = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/support/components/faqs")),
    "support"
  );
...
const feedback = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/support/components/feedback")),
    "support"
  );
const survey = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/support/components/survey")),
    "support"
  );
const serviceNet = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/support/components/serviceNet")),
    "support"
  );
const opVideo = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/support/components/opVideo")),
    "support"
  );
const download = (r: any) =>
  require.ensure(
    [],
    () => r(require("pages/views/support/components/download")),
    "support"
  );
export default [
  {
